...
> A lightweight `.env` loader designed for real-world Node.js apps — automatic environment detection, layered env loading, optional overrides, and a clean API.
...
* Added path resolution (cwd → fallback)
...
[LICENSE](LICENSE) — build cool shit, don’t use it for malware, and don’t pretend you wrote it.
